					...
					<nav id="nav">
						<ul class="sf-menu">
							...
							<?php if ($user_role == 'admin'): ?>
								...
								<li><a href="list-kriteria.php">Kriteria & Bobot</a>
									<ul>
										<li><a href="list-kriteria.php">List Kriteria</a></li>
										<li><a href="tambah-kriteria.php">Tambah Kriteria</a></li>
									</ul>
								</li>
								<li><a href="list-mahasiswa.php">Alternatif</a>
									<ul>
										<li><a href="list-mahasiswa.php">List Mahasiswa</a></li>
										<li><a href="tambah-mahasiswa.php">Tambah Mahasiswa</a></li>
									</ul>
								</li>
							<?php endif; ?>
							<?php if ($user_role == 'admin' || $user_role == 'User'): ?>
								<li><a href="ranking-topsis.php">Perhitungan</a>
									<ul>
